...
/*
  ...
  5. Partition with Disko and install:
     ...
     nix --extra-experimental-features 'nix-command flakes' run github:nix-community/disko -- \
       ...
       --yes-wipe-all-disks \
       --flake 'github:rwade628/dotfiles/main?dir=configs/nixos#pc-incus'
     ...
     nixos-enter --root /mnt -c 'passwd ryan' # Set user password
  ...
  7. SSH in and update to latest (if needed):
     ...
     ssh ryan@<IP>
     nixos-rebuild switch --flake 'github:rwade628/dotfiles/main?dir=configs/nixos#pc-incus'
